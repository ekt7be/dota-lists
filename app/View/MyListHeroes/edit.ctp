...
<div id="page-container" class="row">
	...
	<div id="sidebar" class="col-sm-3">
		...
		<div class="actions">
			...
			<ul class="list-group">
				<li class="list-group-item"><?php echo $this->Form->postLink(__('Delete Hero'), array('action' => 'delete', $this->Form->value('MyListHero.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MyListHero.id'))); ?></li>
